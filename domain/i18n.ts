...
const messages: I18nMessages = {
  ja: {
    ...
    transport: {
      ...
      allTracksLabel: '全',
      markSpeechTitle: '1コマをセリフとしてラベル',
      markSpeechLabel: '話',
      markNonSpeechTitle: '1コマを非セリフとして除外',
      markNonSpeechLabel: '無',
      deleteFrameTitle: '-1f（削除）',
  ...
  en: {
    ...
    transport: {
      ...
      allTracksLabel: 'All',
      markSpeechTitle: 'Label 1 frame as speech',
      markSpeechLabel: 'Sp',
      markNonSpeechTitle: 'Label 1 frame as non-speech',
      markNonSpeechLabel: 'Ns',
      deleteFrameTitle: '-1f (Delete)',
